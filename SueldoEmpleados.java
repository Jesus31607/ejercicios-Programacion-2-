public class SueldoEmpleados{
   public static void main(String [] args){
    ...
    int[][]sueldo={
     ...
     System.out.println("Total pagado de sueldo a los empleados: "+ total);
      int mayor=0; 
        for(int i=0; i<4;i++){
      if(acumulado[i]>acumulado[mayor]){
         ...
         System.out.println("El empleado con mayor ingreso: " + nombres[mayor] + " con un total de: " + acumulado[mayor]);
     System.out.println("\nDetalle acerca de empleados");
